...
export function LoginForm() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-slate-500 mb-6">Sign in to your SOC analyst account</p>

      {/* Google OAuth */}
      <button
        onClick={handleGoogle}
        disabled={googleLoading || loading}
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-300 rounded-lg text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-6"
      >
        {googleLoading ? (
